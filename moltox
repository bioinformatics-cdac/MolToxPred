...
numerical_columns=joblib.load('/app/numerical_columns.pkl')
...
df.to_csv('/app/Padel/molecule.smi', sep='\t', index=False, header=False)
...
for i in fp:
    ...
    padeldescriptor(mol_dir='/app/Padel/molecule.smi', 
...
#unpickling features
with open("/app/feature_list.pkl", "rb") as fp: 
...
## Load Model
trained_model = joblib.load('/app/stacked_model.joblib')
